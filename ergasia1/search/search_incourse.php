...
if(!empty($search_terms)){
	$search_terms = sanitizeInput($search_terms);
}
if(!empty($or_search_terms)){
	$or_search_terms = sanitizeInput($or_search_terms);
}
if(!empty($not_search_terms)){
	$not_search_terms = sanitizeInput($not_search_terms);
}
...
echo "hello";
echo $search_terms."|||".$or_search_terms;
