...
==============================================================================*/
include '../sanitizer/scriptSanitization.php';
...
***********************************************************************************************/
	...
	//CHANGED
    //checking if input contains tags
    if(!empty($search_terms_title)){
    	$search_terms_title = sanitizeInput($search_terms_title);
    }
    if(!empty($search_terms_keywords)){
    	$search_terms_keywords = sanitizeInput($search_terms_keywords);
    }
    if(!empty($search_terms_instructor)){
    	$search_terms_instructor = sanitizeInput($search_terms_instructor);
    }
    if(!empty($search_terms_coursecode)){
    	$search_terms_coursecode = sanitizeInput($search_terms_coursecode);
    }


    while ($mycours = mysql_fetch_array($result))
    {
    	//echo $mycours['intitule']."__";
		...
		echo $search_terms_title."__";
		echo $search_terms_keywords."__";
		echo $search_terms_instructor."__";
		echo $search_terms_coursecode."__";
